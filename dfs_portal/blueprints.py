...
def _factory(partial_module_string, url_prefix):
    ...
    import_name = 'dfs_portal.views.{}'.format(partial_module_string)
...
mlb_dashboard = _factory('mlb.dashboard', '/mlb')


all_blueprints = (examples_alerts, examples_exception, home_index, mlb_dashboard,)
